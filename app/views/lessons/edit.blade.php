...
@section('content')
	...
	{{ Form::model($classe, array('route' => array('classes.update', $classe->id), 'method' => 'PUT')) }}
		...
		<div class="form-group">
			...
			{{ Form::select('tutoria_id', array('0' => 'Select a Tutoria', '1' => '1 Amparo', '2' => '2 Amparo', '3' => '3 Amparo'), null, array('class' => 'form-control')) }}
		</div>
		...
		<div class="form-group">
			<div class="row">
				<div class="col-sm-6">
					...
					{{ Form::input('date', 'start_at', null, array('class' => 'form-control')) }}
				</div>

				<div class="col-sm-6">
					{{ Form::label('end_at', 'Fecha Fin') }}
					{{ Form::input('date', 'end_at', null, array('class' => 'form-control')) }}
				</div>
			</div>
		</div>
